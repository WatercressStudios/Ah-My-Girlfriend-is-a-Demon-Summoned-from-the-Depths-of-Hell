label scene26:
    ...
    show misaki scowl with dissolve
    ...
    show misaki disgustclosed with dissolve
    voice "C-26-11.wav" #Misaki (Kikari)
    riv "Misaki's fine. I'm not in the mood right now, Makoto."
    
    voice "C-26-12.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-26-13.wav" #Misaki (Kikari)
    riv "I… I'm annoyed."
    
    voice "C-26-14.mp3" #Makoto (Reece Bridger)
    pro "'Annoyed?’ I'm sorry?"
    
    voice "C-26-15.wav" #Misaki (Kikari)
    riv "No, not with you - well, maybe a bit, but… feh."
    
    #misaki contemplating
    
    show misaki blushclosed
    voice "C-26-16.wav" #Misaki (Kikari)
    riv "..."
    ...
    show misaki despair
    voice "C-26-54.wav" #Misaki (Kikari)
    riv "...Th-That was… I…"
    
    #misaki pout
    
    show misaki poutclosed
    voice "C-26-55.wav" #Misaki (Kikari)
    riv "...Hmph. Fine, I guess I said those things. I guess."
    
    voice "C-26-56.mp3" #Makoto (Reece Bridger)
    pro "Heh."
    
    voice "C-26-57.wav" #Misaki (Kikari)
    ...
    show misaki blush
    voice "C-26-97.wav" #Misaki (Kikari)
    riv "Crap!"
    
    #whispering
    
    show misaki closedshout
    voice "C-26-98.wav" #Misaki (Kikari)
    ...
    voice "C-26-101.wav" #Misaki (Kikari)
    riv "..."
