label scene27:
    ...
    show beepy fsmileclosed
    show stan winktalk with easeinright:
            align (0.55, 1.0)
    ...
    show bubble xdlaugh with easeinleft:
            align (0.05, 1.0)
    ...
    "Just before she was about to dart off, Mami cut off her exit with pinpoint accuracy in prediction."

    show mami fsmugtalk
    voice "C-27-53.mp3" #Mami 
    ...
    show stan serious
    show beepy feyebrow
    voice "C-27-60.mp3" #Makoto (Reece Bridger)
    pro "...W-What?"
    ...
    show stan pitytalk
    show beepy feyebrow
    voice "C-27-66.mp3" #STan (Dani)
    st "It's okay, you get used to it~!"

    scene endcg with dissolve
