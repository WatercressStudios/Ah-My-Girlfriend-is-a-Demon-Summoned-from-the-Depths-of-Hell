label scene15:
    ...
    "Her words are short. Stuttered. It seems unlike the Countess I knew before."
    show misaki scowl
    ...
    voice "C-15-53.mp3" #Makoto (Reece Bridger)
    pro "What's wrong?"
    ...
    voice "C-15-59.mp3" #Makoto (Reece Bridger)
