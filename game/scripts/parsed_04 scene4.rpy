label scene4:
    ...
    voice "C-4-2.mp3" #Makoto (Reece Bridger)
    pro "{i}I don't sing.{/i}"
    
    voice "C-4-3.mp3" #??? 
    q "Nn…" 
    
    voice "C-4-4.mp3" #STan (Dani)
    ...
    voice "C-4-5.mp3" #Makoto (Reece Bridger)
    pro "...What? How can this be?"
    
    voice "C-4-6.mp3" #STan (Dani)
    st "Hmmmmmm… oh, oh, I think I know!"
    
    voice "C-4-7.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-4-8.mp3" #STan (Dani)
    st "{b}Hey!{/b} Nooooo peeking! It spoils the magic!"
    
    voice "C-4-9.mp3" #Makoto (Reece Bridger)
    pro "What magic!?"
    ...
    voice "C-4-15.mp3" #Makoto (Reece Bridger)
    pro "..."
    ...
    show beepyintrostan with dissolve
    hide beepyintroroll
    
    voice "C-4-32.mp3" #STan (Dani)
    st "{i}(That wasn't like we rehearsed…){/i}" 

    hide beepyintrostan with dissolve
    show beepy neutral
    show stan pity
    ...
    voice "C-4-49.mp3" #Makoto (Reece Bridger)
    pro "...S-Sure?"
    
    show stan smileclosedtalk
    voice "C-4-50.mp3" #STan (Dani)
    ...
    show beepy neutralclosedtalk
    voice "C-4-53.mp3" #Beepy (Hikari)
    bp "She always does that. It's kinda predictable."
    
    show beepy neutralclosed
    voice "C-4-54.mp3" #Makoto (Reece Bridger)
    ...
    show yumi angrytalk with easeinleft
    voice "C-4-72.mp3" #Yumi (Kaito)
    sis "{b}There{/b} you are, Makoto!"
    
    show yumi angry
    voice "C-4-73.mp3" #Makoto (Reece Bridger)
    pro "Ah! Y-Yumi!"
    ...
    voice "C-4-78.mp3" #Makoto (Reece Bridger)
    ...
    show beepy fneutral
    voice "C-4-107.mp3" #Makoto (Reece Bridger)
    pro "It’s… It’s to the right, over there."
    
    show beepy fneutraltalk
    voice "C-4-108.mp3" #Beepy (Hikari)
    bp "Sweet, thanks."
