label scene2:
    ...
    voice "C-2-2.mp3" #Makoto (Reece Bridger)
    pro "Ufufufu~ Sometimes, my foresight’s pristine clarity terrifies even me!"
    ...
    voice "C-2-4.mp3" #Makoto (Reece Bridger)
    pro "...Oh, right, speaking of sodium."
    ...
    voice "C-2-6.mp3" #Makoto (Reece Bridger)
    pro "Ah, one more thing. I must preserve this auspicious moment. It shall serve as a portrait of my tireless preparations." 
    ...
    voice "C-2-7.mp3" #Makoto (Reece Bridger)
    pro "This will do nicely."
    
    voice "C-2-8.mp3" #Makoto (Reece Bridger)
    pro "...Ah, wait, no filters. Filters are ugly and pedestrian."
    
    voice "C-2-9.mp3" #Makoto (Reece Bridger)
    pro "...What am I even doing?"
    
    voice "C-2-10.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-2-11.mp3" #Makoto (Reece Bridger)
    pro "...Shit, how does the Latin part go again? Uh…" 
    
    #read this part in rly bad pronunciation, like, actually struggle
    voice "C-2-12.mp3" #Makoto (Reece Bridger)
    pro "'In… In nomine... Dei nostri Satanas... Luciferi ex… excelsi?"
    ...
    voice "C-2-16.mp3" #Makoto (Reece Bridger)
    pro "Grant me the — {i}w-whoa{/i} -— the in… the indulgences of which I speak! Come... Come forth and answer to your names by… by manifesting my d-desires!"
    ...
    voice "C-2-20.mp3" #Yumi (Kaito)
    sis "{b}If you’re performing another one of your stupid seances or whatever, it’s {i}not funny!{/i} I’m gonna tell Mom and Dad!{/b}"
    
    voice "C-2-21.mp3" #Makoto (Reece Bridger)
    pro "...Shit! This… This isn't good…!" 
    ...
    voice "C-2-22.mp3" #Makoto (Reece Bridger)
    pro "Nn… This wasn't what was supposed to…"
    
    voice "C-2-23.mp3" #Makoto (Reece Bridger)
    pro "Shit, {b}Shit…!{/b}"
