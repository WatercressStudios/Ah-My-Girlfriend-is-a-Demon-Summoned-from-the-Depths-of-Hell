label scene5:
    ...
    voice "C-5-1.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-5-3.mp3" #Makoto (Reece Bridger)
    pro "Jeez, you conk out easily, don't you…?"
    
    voice "C-5-4.mp3" #Beepy (Hikari)
    bp "It's my… amazing power… I can fall asleep anywhere…"
    
    voice "C-5-5.mp3" #Makoto (Reece Bridger)
    pro "W-Wait, you heard that!?"
    
    voice "C-5-6.mp3" #Beepy (Hikari)
    bp "Zzzzz…"
    
    voice "C-5-7.mp3" #Makoto (Reece Bridger)
    pro "A-Alright, enough joking around. Get up! This is {i}my{/i} bed."
    
    voice "C-5-8.mp3" #Beepy (Hikari)
    ...
    voice "C-5-15.mp3" #Beepy (Hikari)
    bp "So this's your room, right? It's plainer than I expected."
    
    show beepy neutral
    voice "C-5-16.mp3" #Makoto (Reece Bridger)
    pro "P-Plain…?"
    
    show beepy neutraltalk
    voice "C-5-17.mp3" #Beepy (Hikari)
    bp "I mean, with your ridiculous get-up, I expected a bunch of screamo posters."
    
    voice "C-5-18.mp3" #Beepy (Hikari)
    bp "Skulls, too. Edgy stuff."
    
    show beepy neutral
    voice "C-5-19.mp3" #Makoto (Reece Bridger)
    ...
    show beepy neutraltalk
    voice "C-5-29.mp3" #Beepy (Hikari)
    bp "Well, no. I have other talents."
    
    voice "C-5-30.mp3" #Beepy (Hikari)
    ...
    voice "C-5-46.mp3" #Makoto (Reece Bridger)
    ...
    show beepy neutraltalk with dissolve
    voice "C-5-51.mp3" #Beepy (Hikari)
    bp "Hoo… Alright, whatever, I'll deal."
    
    voice "C-5-52.mp3" #Beepy (Hikari)
    bp "Now, let's hear something from you."
    
    show beepy neutral
    voice "C-5-53.mp3" #Makoto (Reece Bridger)
    pro "What? Why me?"
    
    show beepy neutraltalk
    voice "C-5-54.mp3" #Beepy (Hikari)
    bp "We're getting to know each other, right? Generally, {i}normal{/i} people try to learn more about each other."
    
    show beepy neutral
    voice "C-5-55.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-5-88.mp3" #Makoto (Reece Bridger)
    pro "Yes. She is the proof I need."
    
    voice "C-5-89.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-5-93.mp3" #Makoto (Reece Bridger)
    pro "Crap!"
    ...
    voice "C-5-94.mp3" #Makoto (Reece Bridger)
    pro "...Shit."
