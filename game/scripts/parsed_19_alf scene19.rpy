label scene19:
    ...
    show lucy neutral
    voice "C-19-3.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-19-6.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-19-9.mp3" #Makoto (Reece Bridger)
    pro "Stop stop stop!"
    ...
    voice "C-19-19.mp3" #Makoto (Reece Bridger)
    ...
    show lucy neutral
    voice "C-19-25.mp3" #Makoto (Reece Bridger)
    pro "Hey! T--"
    
    show lucy serioustalk
    voice "C-19-26.mp3" #Lucy (Vivi)
    lu "Shushshushshush."
    ...
    voice "C-19-36.mp3" #Makoto (Reece Bridger)
    pro "Are you sure?"
    
    show lucy neutraltalk with dissolve
    voice "C-19-37.mp3" #Lucy (Vivi)
    lu "Yeah, hands are awful."
    
    show lucy neutral
    voice "C-19-38.mp3" #Makoto (Reece Bridger)
    pro "N-No, not that."
    ...
    show lucy neutral
    voice "C-19-51.mp3" #Makoto (Reece Bridger)
    pro "I like it."
    
    show lucy neutraltalk
    voice "C-19-52.mp3" #Lucy (Vivi)
    lu "Exactly! It's awf-- What?"
    
    show lucy neutral
    voice "C-19-53.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-19-54.mp3" #Makoto (Reece Bridger)
    pro "There's potential, to be certain."
    
    show lucy smile
    voice "C-19-55.mp3" #Lucy (Vivi)
    lu "I-uhh-- I, thanks."
