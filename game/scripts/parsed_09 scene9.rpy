label scene9:
    ...
    voice "C-9-7.mp3" #Beepy (Hikari)
    bp "...What, this?"
    
    voice "C-9-8.mp3" #Beepy (Hikari)
    bp "It’s no big deal. Bag’s big enough that I can squeeze in no problem."
    
    voice "C-9-9.mp3" #Beepy (Hikari)
    ...
    voice "C-9-17.mp3" #Beepy (Hikari)
    bp "No I won’t. No one else will be able to see me."
    
    voice "C-9-18.mp3" #Beepy (Hikari)
    ...
    voice "C-9-23.mp3" #Misaki (Kikari)
    ...
    voice "C-9-24.mp3" #Misaki (Kikari)
    ...
    voice "C-9-33.mp3" #Misaki (Kikari)
    ...
    voice "C-9-35.mp3" #Misaki (Kikari)
    ...
    show misaki shout
    voice "C-9-36.mp3" #Misaki (Kikari)
    ...
    show misaki smugtalk
    voice "C-9-45.mp3" #Misaki (Kikari)
    ...
    show misaki smiletalk
    voice "C-9-51.mp3" #Misaki (Kikari)
    riv "If you insist~"
    ...
    show misaki closedshout
    voice "C-9-53.mp3" #Misaki (Kikari)
    ...
    show misaki shout
    show stan pity
    voice "C-9-62.mp3" #Misaki (Kikari)
    ...
    voice "C-9-67.mp3" #Misaki (Kikari)
    ...
    show misaki shout
    show stan neutral
    voice "C-9-71.mp3" #Misaki (Kikari)
    ...
    show misaki stammer
    voice "C-9-73.mp3" #Misaki (Kikari)
    riv "H-Huh!?"
    ...
    show stan wink
    voice "C-9-76.mp3" #Misaki (Kikari)
    ...
    show misaki shoutblush
    voice "C-9-86.mp3" #Misaki (Kikari)
    ...
    show misaki stammer
    voice "C-9-91.mp3" #Misaki (Kikari)
    ...
    show misaki stammer
    voice "C-9-99.mp3" #Misaki (Kikari)
    riv "{b}What the--!?{/b}"
    ...
    show beepy angry
    show stan sad
    voice "C-9-102.mp3" #Beepy (Hikari)
    ...
    show misaki despair
    voice "C-9-103.mp3" #Misaki (Kikari)
    riv "Wha… Wha…"

    show misaki shout
    voice "C-9-104.mp3" #Misaki (Kikari)
    ...
    voice "C-9-108.mp3" #Misaki (Kikari)
    riv "This is {i}so{/i} unfair!"
    
    show misaki closedshout
    
    voice "C-9-109.mp3" #Misaki (Kikari)
    ...
    voice "C-9-112.mp3" #Misaki (Kikari)
    riv "Yeah, well all {i}she’s{/i} good for is driving me up the wall!"
    
    show misaki shout
    
    voice "C-9-113.mp3" #Misaki (Kikari)
    ...
    show misaki fshout
    voice "C-9-114.mp3" #Misaki (Kikari)
    ...
    show beepy neutral with easeinleft:
            align (0.1,1.0)
    voice "C-9-116.mp3" #Beepy (Hikari)
    ...
    show misaki fshout
    voice "C-9-122.mp3" #Misaki (Kikari)
    ...
    voice "C-9-126.mp3" #Misaki (Kikari)
    ...
    show misaki smugclosed
    voice "C-9-128.mp3" #Misaki (Kikari)
    ...
    show misaki smiletalk
    voice "C-9-130.mp3" #Misaki (Kikari)
    riv "Gladly."
    ...
    show beepy neutral with easeinleft:
            align (0.1,1.0)
    voice "C-9-138.mp3" #Beepy (Hikari)
    bp "Mmn… I guess."
    
    show stan neutral
    show beepy dreamworks
    voice "C-9-139.mp3" #Beepy (Hikari)
    ...
    voice "C-9-142.mp3" #Beepy (Hikari)
    ...
    show beepy angry
    voice "C-9-151.mp3" #Beepy (Hikari)
