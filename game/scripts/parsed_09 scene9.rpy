label scene9:
    ...
    voice "C-9-1.mp3" #Makoto (Reece Bridger)
    ...
    show misakiintroclosed with dissolve
    hide black
    ...
    show misakiintroopen
    hide misakiintroangry
    ...
    show misakiintroclosed
    hide misakiintroopen
    ...
    hide misakiintrolook with dissolve
    ...
    show misaki smugtalk
    voice "C-9-45.wav" #Misaki (Kikari)
    ...
    voice "C-9-46.mp3" #Makoto (Reece Bridger)
    pro "D-Demon summoning?"
    
    show misaki smiletalk
    voice "C-9-47.wav" #Misaki (Kikari)
    riv "Why the sudden hesitation, dear Sebastian? You should be celebrating your inevitable defeat."
    
    show misaki smugclosedtalk
    voice "C-9-48.wav" #Misaki (Kikari)
    ...
    voice "C-9-49.mp3" #Makoto (Reece Bridger)
    pro "Is that so? Then prove it!"
    
    show misaki smug
    voice "C-9-50.mp3" #Makoto (Reece Bridger)
    pro "Show me this demon of yours so that I may smite them!"
    
    show misaki smiletalk
    voice "C-9-51.wav" #Misaki (Kikari)
    riv "If you insist~"
    ...
    show misaki smugclosedtalk
    voice "C-9-52.wav" #Misaki (Kikari)
    ...
    show misaki closedshout
    voice "C-9-53.wav" #Misaki (Kikari)
    riv "{i}I said,{/i} ‘Come hither, my faithful servant! Make your presence known and--’"
    
    voice "C-9-54.mp3" #??? 
    q "Yes, yes, I’m coming~! {i}Sooo{/i} sorry about the wait, it takes forever to look presentable, you know!"
    
    show misaki smug
    voice "C-9-55.mp3" #Makoto (Reece Bridger)
    pro "Wait… that voice!"
    ...
    show misaki closedshout:
            align (0.99, 1.0)
    voice "C-9-60.wav" #Misaki (Kikari)
    ...
    show misaki shout
    show stan pity
    voice "C-9-62.wav" #Misaki (Kikari)
    ...
    voice "C-9-67.wav" #Misaki (Kikari)
    ...
    show misaki shout
    show stan neutral
    voice "C-9-71.wav" #Misaki (Kikari)
    ...
    voice "C-9-72.mp3" #Makoto (Reece Bridger)
    pro "Hey! What the hell’s going on!? Why are {i}you{/i} here?"

    #show Misaki surprised

    show misaki stammer
    voice "C-9-73.wav" #Misaki (Kikari)
    riv "H-Huh!?"

    #show Satan smiling, eyes open

    show stan neutraltalk
    voice "C-9-74.mp3" #STan (Dani)
    st "Oh, if it isn’t Makoto~! Long time no see!"
    
    show stan winktalk
    voice "C-9-75.mp3" #STan (Dani)
    ...
    show stan wink
    voice "C-9-76.wav" #Misaki (Kikari)
    riv "Wait, time-out! You know her!?"
    
    voice "C-9-77.mp3" #Makoto (Reece Bridger)
    ...
    show misaki shout
    show stan serious
    voice "C-9-78.wav" #Misaki (Kikari)
    ...
    voice "C-9-85.wav" #Misaki (Kikari)
    riv "G-Get off me!"
    ...
    show stan serious with easeinleft:
            align (0.66, 1.0)
    show misaki scowlblush with easeinleft:
            align (0.9, 1.0)
    "My rival shoves Satan away and points straight at her."

    show misaki shoutblush
    voice "C-9-86.wav" #Misaki (Kikari)
    ...
    show stan neutral
    show misaki surprise
    voice "C-9-90.mp3" #Makoto (Reece Bridger)
    pro "H-Huh!?"
    
    show misaki stammer
    voice "C-9-91.wav" #Misaki (Kikari)
    riv "What demon? What are you talking about!?"
    
    show stan serioustalk
    voice "C-9-92.mp3" #STan (Dani)
    ...
    voice "C-9-94.wav" #Misaki (Kikari)
    riv "You have gotta be--"
    
    show stan neutraltalk
    voice "C-9-95.mp3" #STan (Dani)
    st "Where is she, anyway?"
    
    show stan winktalk
    voice "C-9-96.mp3" #STan (Dani)
    st "Oh Beeeepyyyyyy~!"
    ...
    show misaki surprise
    show beepy neutral with easeinleft:
            align (0.20, 1.0)
    voice "C-9-97.wav" #Beepy (Hikari)
    bp "Keep it down… I’m right here."
    
    voice "C-9-98.mp3" #Makoto (Reece Bridger)
    pro "{b}Ack!{/b}"

    #show Misaki surprised

    show misaki stammer
    voice "C-9-99.wav" #Misaki (Kikari)
    riv "{b}What the--!?{/b}"
    
    show stan neutraltalk
    voice "C-9-100.mp3" #STan (Dani)
    st "Oh, {i}there{/i} you are~! I see you’re adjusting well!"

    #show Satan concerned

    show stan sadtalk
    voice "C-9-101.mp3" #STan (Dani)
    ...
    show beepy angry
    show stan sad
    voice "C-9-102.wav" #Beepy (Hikari)
    ...
    show misaki despair
    voice "C-9-103.wav" #Misaki (Kikari)
    riv "Wha… Wha…"

    show misaki shout
    voice "C-9-104.wav" #Misaki (Kikari)
    ...
    show misaki fshout
    voice "C-9-114.wav" #Misaki (Kikari)
    riv "You’d better give me a good reason for this!"
    
    show misaki fscowl
    show stan serious with easeinright:
            align (0.9, 1.0)
    ...
    show beepy neutral with easeinleft:
            align (0.1,1.0)
    voice "C-9-116.wav" #Beepy (Hikari)
    bp "Just tell them already."
    
    show stan bashful
    voice "C-9-117.mp3" #STan (Dani)
    st "Ihihihihi... {i}Welllll,{/i} how do I put this…"
    
    voice "C-9-118.mp3" #STan (Dani)
    ...
    voice "C-9-123.mp3" #Makoto (Reece Bridger)
    pro "Well… looks like our fates have intertwined after all."
    
    show misaki scowl
    voice "C-9-124.mp3" #Makoto (Reece Bridger)
    ...
    show misaki smugclosedtalk
    voice "C-9-127.wav" #Misaki (Kikari)
    riv "Hehe… Hehehehahaha. {b}Hahahahahahaha!{/b}"
    
    show misaki smugclosed
    voice "C-9-128.wav" #Misaki (Kikari)
    ...
    show misaki smug
    voice "C-9-129.mp3" #Makoto (Reece Bridger)
    pro "Well, don’t keep me waiting, my eternal enemy. Show your hand!"
    
    show misaki smiletalk
    voice "C-9-130.wav" #Misaki (Kikari)
    riv "Gladly."
    ...
    show beepy neutral with easeinleft:
            align (0.1,1.0)
    voice "C-9-138.wav" #Beepy (Hikari)
    bp "Mmn… I guess."
    
    show stan neutral
    show beepy dreamworks
    voice "C-9-139.wav" #Beepy (Hikari)
    bp "Why are you so excited, though? Should an {i}idol{/i} really like something so violent…?"

    show stan scheming
    voice "C-9-140.mp3" #STan (Dani)
    ...
    show beepy neutral with easeinleft
    voice "C-9-150.mp3" #Makoto (Reece Bridger)
    pro "Come, Belphegor of Sloth! We must begin our training immediately!"
    
    show beepy angry
    voice "C-9-151.wav" #Beepy (Hikari)
