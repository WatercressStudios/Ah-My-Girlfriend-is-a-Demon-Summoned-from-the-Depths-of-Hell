label scene13:
    ...
    show yumi exasperatedtalk
    voice "C-13-16.mp3" #Yumi (Kaito)
    sis "Okay, just stop."
    
    voice "C-13-17.mp3" #Yumi (Kaito)
    sis "I already have enough to worry about and your stupid gimmick isn’t helping."
    
    voice "C-13-18.mp3" #Makoto (Reece Bridger)
    pro "Erk--!"
    ...
    show lucy neutral
    show yumi worrytalk
    voice "C-13-45.mp3" #Yumi (Kaito)
    sis "A duel…?"
    
    voice "C-13-46.mp3" #Makoto (Reece Bridger)
    ...
    "Without much else to say on the matter, everyone makes their way to the front of the house - everyone except for Beepy, that is."

    #enter Beepy stage left

    show beepy neutral
    voice "C-13-69.mp3" #Makoto (Reece Bridger)
    ...
    voice "C-13-73.mp3" #Makoto (Reece Bridger)
