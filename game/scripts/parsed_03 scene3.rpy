label scene3:
    ...
    voice "C-3-1.mp3" #Makoto (Reece Bridger)
    pro "..."
    ...
    voice "C-3-3.mp3" #Makoto (Reece Bridger)
    pro "..."
    
    voice "C-3-4.mp3" #Makoto (Reece Bridger)
    pro "T-Tomato… juice…?"
    ...
    show stan neutral with easeinright
    ...
    show stan pity
    voice "C-3-18.mp3" #Makoto (Reece Bridger)
    ...
    show stan smileclosedtalk
    voice "C-3-34.mp3" #STan (Dani)
    st "I wanted to wish you, congratulations!"
    
    voice "C-3-35.mp3" #Makoto (Reece Bridger)
    pro "...Con-Congratulations?"
    
    show stan winktalk
    voice "C-3-36.mp3" #STan (Dani)
    st "{b}Congratulations~!{/b}"
    
    show stan wink
    voice "C-3-37.mp3" #Makoto (Reece Bridger)
    ...
    show stan wincetalk
    voice "C-3-52.mp3" #STan (Dani)
    st "Ahh, yeah… I've had to take up part-time work."
    
    show stan sadclosed
    voice "C-3-53.mp3" #STan (Dani)
    ...
    show stan neutraltalk
    voice "C-3-58.mp3" #STan (Dani)
    st "Yeah, right? I knew you'd understand!"
    
    show stan winktalk
    voice "C-3-59.mp3" #STan (Dani)
