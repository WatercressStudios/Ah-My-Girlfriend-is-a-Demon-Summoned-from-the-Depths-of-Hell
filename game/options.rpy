...
init -1 python hide:
    ...
    config.window_title = u"Ah! My Girlfriend is a Demon Summoned from the Depths of Hell!"
    ...
    config.main_menu_music = "music/Poppy Shop.ogg"
...
python early:
    config.save_directory = "Ah! My Girlfriend is a Demon Summoned from the Depths of Hell!-1511239607"
...
init python:
    ...
    build.directory_name = "Ah-My-Girlfriend-is-a-Demon-Summoned-from-the-Depths-of-Hell-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Ah-My-Girlfriend-is-a-Demon-Summoned-from-the-Depths-of-Hell"
